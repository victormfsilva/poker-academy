...
const MODULES = [
  ...
  { id: 10, name: 'Defesa vs CBet', desc: 'O que fazer quando apostam em você no flop', icon: '🛡️', color: '#4a90e2' },
  { id: 11, name: 'Check-Raise', desc: 'A arma mais poderosa fora de posição', icon: '⚡', color: '#f5a623' },
